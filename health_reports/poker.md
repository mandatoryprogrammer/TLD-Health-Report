...
* The listed nameservers for poker. all report the same set of nameservers.
...
* SOA refresh for poker. too small (10800) - recommended >= 14400. SOA refresh decides how often a secondary name server should check the primary name server for zone updates.
