...
* The listed nameservers for srl. all report the same set of nameservers.
...
* SOA refresh for srl. too small (10800) - recommended >= 14400. SOA refresh decides how often a secondary name server should check the primary name server for zone updates.
